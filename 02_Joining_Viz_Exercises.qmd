...
joined_counties <- inner_join(counties_elexresults, counties_demographics, by = "geoid")
joined_counties_pennsylvania <- joined_counties %>% 
  filter(state_code == "PA")

nonwhite_voters <- joined_counties %>% 
